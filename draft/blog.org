...
その辺も別途確認していきたいと思います。
** DONE ECS Service Connectを試す                                       :aws:
...
* 2023
** DONE キーボードをMoonLanderに変更した                         :moonlander:
...
** DONE AWSの新しい資格 Data Engineer Associateのベータ版を受験してきた :aws:
...
* 2024
** DONE EKSでのMountpoint for Amazon S3を試す                             :aws:eks:
...
** TODO AWS CloudShellのつらみは全部tmuxが解決してくれる
:PROPERTIES:
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :archives '(\"2024\" \"2024-02\")
:EXPORT_FILE_NAME: 202402132045
:END:
