+++
title = "Chroma用のスタイルシートを作成した"
lastmod = 2020-08-10T16:50:26+09:00
tags = ["hugo"]
draft = true
archives = ["2019", "2019-10"]
+++

といっても、Chromaの解釈とEmacsの解釈でちがうところがあるので、
完全に同じではないが、そこはご愛嬌ということで。
例えば、Emacsだと `default` faceあつかいになるところが、Chromaだとキーワードとして解釈される、とか。
